...
function Home(){
    return(
        <div className="home">
			...
			<div className="home_school section">
				...
				<div className="box">
					<div className="box_title">
						...
						<p><b>Hottingen</b></p>
						<p>2017 - Heute</p>
						<button onClick="/">Zeugnisse</button>
					</div>
				</div>
			...
			<div className="home_references section">
				<h2>Referenzen</h2>
				<div className="box">
					<div className="box_title">
						<h4>Lehrer BZZ</h4>
