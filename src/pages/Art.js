    ...
    return(
        <div className="art">
            ...
            <div className="art_paint section">
                <h2>Zeichnungen</h2>
                <Carousel
                    title="Zeichnen ist eines meiner Lieblingshobbys, da dies sehr meditativ wirkt und ich dabei maine Kreativität entfalten lassen kann."
            ...
            <div className="art_spray section">
                <h2>Grafitti</h2>
                <Carousel
                    title="Seit ich dieses Medium ausprobiert hatte, fing ich an jeden Sommer an legalen Orten zu Sprayen, da mit diese einzigartige Technique viele neues ermöglicht."
